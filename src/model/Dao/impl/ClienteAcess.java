...
public class ClienteAcess implements ClienteDao {
	...
	public void LeituraCliente(Map<Integer, Cliente> map) {
		String caminho = "C:\\Clientes\\Clientes.csv";
		try (BufferedReader brr = new BufferedReader(new FileReader(caminho))) {
			...
			System.out.println("Instalando novo banco de dados...");
			new File("C:\\Clientes").mkdir();
			System.out.println("Novo banco criado! ");
		}
	}
	...
	public String caminho() {
		return "C:\\Clientes\\Clientes.csv";  
	}
